...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //substrings detailstrings array ตัดข้อความไม่เกิน30ตัว
        shortStrings = new String[detailStrings.length]; //จองพื้นที่หน่วยความจำให้shortStrings
        ...
        //create listview
        //active when click list view - moredetails
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            }//เมื่อมีการคลิกข้อมูลตำแหน่งใดจะเก็บจำแหน่งข้อมูลจากการคลิก
        });
    }
    ...
    public void onClickTestLayout(View view) {
